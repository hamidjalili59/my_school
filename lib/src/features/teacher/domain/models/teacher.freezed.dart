...
abstract class $TeacherCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@HiveField(0) int? teacherId, @HiveField(1) BasicInfoModel? basicInfo});
}
...
class _$_Teacher implements _Teacher {
  _$_Teacher({@HiveField(0) this.teacherId, @HiveField(1) this.basicInfo});
...
abstract class _Teacher implements Teacher {
  factory _Teacher(
      {@HiveField(0) final int? teacherId,
      @HiveField(1) final BasicInfoModel? basicInfo}) = _$_Teacher;
