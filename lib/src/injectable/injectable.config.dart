...
import 'package:my_school/src/injectable/module_injection/feature/teacher_feature_module.dart'
    as _i115;
import 'package:my_school/src/presentation/auth/bloc/auth_bloc.dart' as _i99;
...
import 'package:my_school/src/presentation/exam/bloc/exam/exam_bloc.dart'
    as _i102;
import 'package:my_school/src/presentation/home/bloc/home_bloc.dart' as _i103;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i49.GetSchoolsUseCase>(
        () => schoolFeatureModule.getSchoolsUseCase);
    gh.factory<_i50.GetScoreUseCase>(() => scoreFeatureModule.getScoresUseCase);
    gh.factory<_i51.GetStudentParentUseCase>(
        () => studentFeatureModule.getStudentParentUseCase);
    gh.factory<_i52.GetStudentUseCase>(
        () => studentFeatureModule.getStudentsUseCase);
    gh.factory<_i53.GetTeacherClassroomsUseCase>(
        () => classroomFeatureModule.getTeacherClassroomDataUseCase);
    gh.factory<_i54.GetTeacherUseCase>(
        () => teacherFeatureModule.getTeachersUseCase);
    gh.factory<_i55.LogoutAuthDataUseCase>(
        () => authFeatureModule.logoutAuthDataUseCase);
    gh.factory<_i56.MediatorLocalDataSource>(
        () => mediatorFeatureModule.localDS);
    gh.factory<_i57.MediatorRemoteDataSource>(
        () => mediatorFeatureModule.remoteDS);
    gh.factory<_i58.MediatorRepository>(() => mediatorFeatureModule.repo);
    gh.factory<_i59.OtpHandshakeUseCase>(
        () => authFeatureModule.otpAuthorizaUseCase);
    gh.factory<_i60.ParentLocalDataSource>(() => parentFeatureModule.localDS);
    gh.factory<_i61.ParentRemoteDataSource>(() => parentFeatureModule.remoteDS);
    gh.factory<_i62.ParentRepository>(() => parentFeatureModule.repo);
    gh.factory<_i63.RemoveClassroomUseCase>(
        () => classroomFeatureModule.removeClassroomUseCase);
    gh.factory<_i64.RemoveCourseUseCase>(
        () => courseFeatureModule.removeCourseUseCase);
    gh.factory<_i65.RemoveExamUseCase>(
        () => examFeatureModule.removeExamUseCase);
    gh.factory<_i66.RemoveMediatorUseCase>(
        () => mediatorFeatureModule.removeMediatorUseCase);
    gh.factory<_i67.RemoveScoreUseCase>(
        () => scoreFeatureModule.removeScoreUseCase);
    gh.factory<_i68.RemoveStudentUseCase>(
        () => studentFeatureModule.removeStudentUseCase);
    gh.factory<_i69.RemoveTeacherUseCase>(
        () => teacherFeatureModule.removeTeacherUseCase);
    gh.factory<_i70.RequestInterceptor>(() => _i70.RequestInterceptor());
    gh.lazySingleton<_i71.RollcallBloc>(
        () => _i71.RollcallBloc(gh<_i48.GetRollCallsUseCase>()));
    gh.factory<_i72.RollcallLocalDataSource>(
        () => rollcallFeatureModule.localDS);
    gh.factory<_i73.RollcallRemoteDataSource>(
        () => rollcallFeatureModule.remoteDS);
    gh.factory<_i74.RollcallRepository>(() => rollcallFeatureModule.repo);
    gh.lazySingleton<_i75.SchoolBloc>(
        () => _i75.SchoolBloc(gh<_i49.GetSchoolsUseCase>()));
    gh.factory<_i76.SchoolRemoteDataSource>(() => schoolFeatureModule.remoteDS);
    gh.factory<_i77.SchoolRepository>(() => schoolFeatureModule.repo);
    gh.lazySingleton<_i78.ScoreBloc>(() => _i78.ScoreBloc(
          gh<_i50.GetScoreUseCase>(),
          gh<_i67.RemoveScoreUseCase>(),
        ));
    gh.lazySingleton<_i79.ScoreBoardBloc>(() => _i79.ScoreBoardBloc(
          gh<_i52.GetStudentUseCase>(),
          gh<_i8.AddScoreUseCase>(),
        ));
    gh.factory<_i80.ScoreLocalDataSource>(() => scoreFeatureModule.localDS);
    gh.factory<_i81.ScoreRemoteDataSource>(() => scoreFeatureModule.remoteDS);
    gh.factory<_i82.ScoreRepository>(() => scoreFeatureModule.repo);
    gh.lazySingleton<_i83.SplashBloc>(
        () => _i83.SplashBloc(gh<_i33.GetCachedAuthDataUseCase>()));
    gh.factory<_i84.StudentLocalDataSource>(() => studentFeatureModule.localDS);
    gh.factory<_i85.StudentRemoteDataSource>(
        () => studentFeatureModule.remoteDS);
    gh.factory<_i86.StudentRepository>(() => studentFeatureModule.repo);
    gh.lazySingleton<_i87.TeacherClassroomBloc>(() =>
        _i87.TeacherClassroomBloc(gh<_i53.GetTeacherClassroomsUseCase>()));
    gh.lazySingleton<_i88.TeacherDetailBloc>(() => _i88.TeacherDetailBloc(
          gh<_i46.GetMediatorUseCase>(),
          gh<_i6.AddMediatorUseCase>(),
          gh<_i66.RemoveMediatorUseCase>(),
        ));
    gh.factory<_i89.TeacherLocalDataSource>(() => teacherFeatureModule.localDS);
    gh.factory<_i90.TeacherRemoteDataSource>(
        () => teacherFeatureModule.remoteDS);
    gh.factory<_i91.TeacherRepository>(() => teacherFeatureModule.repo);
    gh.factory<_i92.UpdateClassroomUseCase>(
        () => classroomFeatureModule.updateClassroomUseCase);
    gh.factory<_i93.UpdateCourseUseCase>(
        () => courseFeatureModule.updateCourseUseCase);
    gh.factory<_i94.UpdateExamUseCase>(
        () => examFeatureModule.updateExamUseCase);
    gh.factory<_i95.UpdateParentUseCase>(
        () => parentFeatureModule.updateParentUseCase);
    gh.factory<_i96.UpdateScoreUseCase>(
        () => scoreFeatureModule.updateScoreUseCase);
    gh.factory<_i97.UpdateStudentUseCase>(
        () => studentFeatureModule.updateStudentUseCase);
    gh.factory<_i98.UpdateTeacherUseCase>(
        () => teacherFeatureModule.updateTeacherUseCase);
    gh.factory<_i99.AuthBloc>(() => _i99.AuthBloc(
          gh<_i59.OtpHandshakeUseCase>(),
          gh<_i14.CacheAuthDataUseCase>(),
          gh<_i55.LogoutAuthDataUseCase>(),
        ));
    gh.lazySingleton<_i100.ClassroomBloc>(() => _i100.ClassroomBloc(
          gh<_i43.GetClassroomsUseCase>(),
          gh<_i3.AddClassroomUseCase>(),
          gh<_i53.GetTeacherClassroomsUseCase>(),
          gh<_i92.UpdateClassroomUseCase>(),
          gh<_i63.RemoveClassroomUseCase>(),
        ));
    gh.lazySingleton<_i101.CourseBloc>(() => _i101.CourseBloc(
          gh<_i44.GetCoursesUseCase>(),
          gh<_i4.AddCourseUseCase>(),
          gh<_i93.UpdateCourseUseCase>(),
          gh<_i64.RemoveCourseUseCase>(),
        ));
    gh.lazySingleton<_i102.ExamBloc>(() => _i102.ExamBloc(
          gh<_i45.GetExamsUseCase>(),
          gh<_i5.AddExamUseCase>(),
          gh<_i65.RemoveExamUseCase>(),
        ));
    gh.factory<_i103.HomeBloc>(
        () => _i103.HomeBloc(gh<_i55.LogoutAuthDataUseCase>()));
    gh.lazySingleton<_i104.StudentBloc>(() => _i104.StudentBloc(
          gh<_i52.GetStudentUseCase>(),
          gh<_i9.AddStudentUseCase>(),
          gh<_i51.GetStudentParentUseCase>(),
          gh<_i97.UpdateStudentUseCase>(),
          gh<_i68.RemoveStudentUseCase>(),
        ));
    gh.lazySingleton<_i105.TeacherBloc>(() => _i105.TeacherBloc(
          gh<_i54.GetTeacherUseCase>(),
          gh<_i10.AddTeacherUseCase>(),
          gh<_i98.UpdateTeacherUseCase>(),
          gh<_i69.RemoveTeacherUseCase>(),
        ));
    return this;
  }
}
...
class _$ClassroomFeatureModule extends _i107.ClassroomFeatureModule {}

class _$CourseFeatureModule extends _i108.CourseFeatureModule {}

class _$ExamFeatureModule extends _i109.ExamFeatureModule {}

class _$MediatorFeatureModule extends _i110.MediatorFeatureModule {}

class _$ParentFeatureModule extends _i111.ParentFeatureModule {}

class _$RollcallFeatureModule extends _i112.RollcallFeatureModule {}

class _$ScoreFeatureModule extends _i113.ScoreFeatureModule {}

class _$StudentFeatureModule extends _i114.StudentFeatureModule {}

class _$TeacherFeatureModule extends _i115.TeacherFeatureModule {}

class _$SchoolFeatureModule extends _i116.SchoolFeatureModule {}
