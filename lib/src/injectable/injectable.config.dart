...
import '../features/score/data/data_sources/remote/score_remote_data_source.dart'
    as _i65;
import '../features/score/domain/repositories/score_repository.dart' as _i66;
...
import '../presentation/rollcall/bloc/rollcall_bloc.dart' as _i60;
import '../presentation/splash/bloc/splash_bloc.dart' as _i67;
import 'module_injection/feature/auth_feature_module.dart' as _i89;
import 'module_injection/feature/classroom_feature_module.dart' as _i82;
import 'module_injection/feature/course_feature_module.dart' as _i83;
import 'module_injection/feature/exam_feature_module.dart' as _i84;
import 'module_injection/feature/parent_feature_module.dart' as _i90;
import 'module_injection/feature/rollcall_feature_module.dart' as _i85;
import 'module_injection/feature/score_feature_module.dart' as _i86;
import 'module_injection/feature/student_feature_module.dart' as _i87;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i60.RollcallBloc>(() => _i60.RollcallBloc());
  gh.factory<_i61.RollcallLocalDataSource>(() => rollcallFeatureModule.localDS);
  gh.factory<_i62.RollcallRemoteDataSource>(
      () => rollcallFeatureModule.remoteDS);
  gh.factory<_i63.RollcallRepository>(() => rollcallFeatureModule.repo);
  gh.factory<_i64.ScoreLocalDataSource>(() => scoreFeatureModule.localDS);
  gh.factory<_i65.ScoreRemoteDataSource>(() => scoreFeatureModule.remoteDS);
  gh.factory<_i66.ScoreRepository>(() => scoreFeatureModule.repo);
  gh.factory<_i67.SplashBloc>(
      () => _i67.SplashBloc(get<_i32.GetCachedAuthDataUseCase>()));
  gh.factory<_i68.StudentLocalDataSource>(() => studentFeatureModule.localDS);
  gh.factory<_i69.StudentRemoteDataSource>(() => studentFeatureModule.remoteDS);
  gh.factory<_i70.StudentRepository>(() => studentFeatureModule.repo);
...
class _$ClassroomFeatureModule extends _i82.ClassroomFeatureModule {}

class _$CourseFeatureModule extends _i83.CourseFeatureModule {}

class _$ExamFeatureModule extends _i84.ExamFeatureModule {}

class _$RollcallFeatureModule extends _i85.RollcallFeatureModule {}

class _$ScoreFeatureModule extends _i86.ScoreFeatureModule {}

class _$StudentFeatureModule extends _i87.StudentFeatureModule {}

class _$TeacherFeatureModule extends _i88.TeacherFeatureModule {}

class _$AuthFeatureModule extends _i89.AuthFeatureModule {}

class _$ParentFeatureModule extends _i90.ParentFeatureModule {}
